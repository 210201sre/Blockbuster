...
public class GameServiceTests {
	...
	public void testFindAll() {
		...
		result.add(new Game(2, "Second", GENRE.BATTLE_ROYALE, CONSOLES.DREAMCAST, "2nd Publisher", "2nd Developer", LocalDate.of(1983, 1, 13)));
		result.add(new Game(3, "Third", GENRE.FIRST_PERSON_SHOOTER, CONSOLES.NES, "3rd Publisher", "3rd Developer", LocalDate.of(1983, 1, 13)));
	...
	public void testSearchByName() {
		...
		result.add(testGame.get());
		result.add(new Game(2, "Second", GENRE.BATTLE_ROYALE, CONSOLES.DREAMCAST, "2nd Publisher", "2nd Developer", LocalDate.of(1983, 1, 13)));
		result.add(new Game(3, "Sthird", GENRE.FIRST_PERSON_SHOOTER, CONSOLES.NES, "3rd Publisher", "3rd Developer", LocalDate.of(1983, 1, 13)));
